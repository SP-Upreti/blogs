...
export default function Details() {
    return (
        <>
            <Navbar />
            <div className="flex max-w-7xl py-4 gap-4 mx-auto flex-col xl:flex-row  ">
                <div className="w-[70%]">
                    <h2 className="font-semibold text-2xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure autem culpa inventore possimus minima fugiat?</h2>
                ...
                <div className="w-[30%]  border p-4 mx-4 h-fit pb-4">
