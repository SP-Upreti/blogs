...
export default function Footer() {
    ...
    return (
        <footer className="text-gray-500 bg-white dark:bg-background px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    ...
                    >
                        ...
                        <div className="max-w-sm focus:outline flex items-center border rounded-md p-1">
                            <input
                                type="email"
